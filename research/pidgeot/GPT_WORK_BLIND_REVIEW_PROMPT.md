# Prompt for independent blind review
...
Write a self-contained report that a competitive Pokémon player can read without having seen this conversation.
...
At the end, freeze the blind conclusion explicitly so it can later be compared with the designer's explanation without retroactively rewriting this report.
